...
Scope: Dispatched when the diff is 200+ lines, or any other specialist found a CRITICAL finding. Runs AFTER other specialists, not in the initial parallel batch.
